...
namespace backend.Migrations
{
    ...
    public partial class Version2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GreetingMessage = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FallbackMessage = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ShowAvatar = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WidgetPosition = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatbotSettings_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatbotSettings_CompanyId",
